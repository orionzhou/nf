...
if __name__ == "__main__":
    ...
    sp2.add_argument('--gap', default=10, help = 'gap (N) length')
    sp2.add_argument('--min_frag_len', default=50, help = 'minimum fragment length')
    sp2.add_argument('--min_seq_len', default=100, help = 'minimum sequence length')
    sp2.add_argument('--min_nseq', default=50, help = 'minimum number of sequence records')
